...
void MainWindow::AtualizarDashboard()
{
    ...
    ui->Entradas->setText(QString("R$ %1").arg(m_Pessoa->Entradas(hoje.month(), hoje.year()), 0, 'f', 2));
    ui->Saidas->setText(QString("R$ %1").arg(m_Pessoa->Saidas(hoje.month(), hoje.year()), 0, 'f', 2));
